...
#May1: had 2 and 1
#May2: Should change back to 3 and 1 based on the example
...
# Use tutorial to get graphs of the data

# Convert to DataFrame
df_detailed = pd.DataFrame(detailed_data)
# Save to CSV
df_detailed.to_csv('snr_detailed_output_3Electrodes.csv', index=False)
...
df_pivoted.to_csv('snr_pivoted_output_3Electrodes.csv', index=False)
