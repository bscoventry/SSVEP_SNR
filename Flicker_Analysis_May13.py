...
#For 2 faster videos
i_bin_2hz = np.argmin(abs(freqs - stim_freq_2hz))
i_bin_48hz = np.argmin(abs(freqs - stim_freq_48hz))

#i_bin_1hz = np.argmin(abs(freqs - stim_freq_1hz))
i_bin_42hz = np.argmin(abs(freqs - stim_freq_42hz))


#freq_list = [i_bin_3hz, i_bin_6hz, i_bin_12hz]
#freq_names_list = ["3Hz", "6Hz", "12Hz"]

freq_list = [i_bin_2hz, i_bin_3hz, i_bin_42hz, i_bin_48hz, i_bin_6hz]#, i_bin_12hz]
freq_names_list = ["2Hz", "3Hz", "42Hz", "48Hz", "6Hz"]#, "12Hz"]
...
# Save to CSV
df_detailed.to_csv('snr_detailed_output_Topo.csv', index=False)
...
df_pivoted.to_csv('snr_pivoted_output_Topo.csv', index=False)




#F1 at 4.8hz
snrs_F1 = snrs[i_trial_F1, :, i_bin_48hz]
snrs_F1_chaverage = snrs_F1.mean(axis=0)
# plot SNR topography
fig, ax = plt.subplots(1)
mne.viz.plot_topomap(snrs_F1_chaverage, epochs.info, vlim=(1, None), axes=ax)
...
# plot SNR topography
fig, ax = plt.subplots(1)
mne.viz.plot_topomap(snrs_H2_chaverage, epochs.info, vlim=(1, None), axes=ax)
...
#H4 at 3hz
snrs_H4 = snrs[i_trial_H4, :, i_bin_3hz]
snrs_H4_chaverage = snrs_H4.mean(axis=0)
# plot SNR topography
fig, ax = plt.subplots(1)
mne.viz.plot_topomap(snrs_H4_chaverage, epochs.info, vlim=(1, None), axes=ax)

#H4 at 2.2hz
snrs_H4 = snrs[i_trial_H4, :, i_bin_2hz]
snrs_H4_chaverage = snrs_H4.mean(axis=0)
# plot SNR topography
fig, ax = plt.subplots(1)
mne.viz.plot_topomap(snrs_H4_chaverage, epochs.info, vlim=(1, None), axes=ax)
...
# plot SNR topography
fig, ax = plt.subplots(1)
mne.viz.plot_topomap(snrs_C1_chaverage, epochs.info, vlim=(1, None), axes=ax)
...
# plot SNR topography
fig, ax = plt.subplots(1)
mne.viz.plot_topomap(snrs_D1_chaverage, epochs.info, vlim=(1, None), axes=ax)
...
# plot SNR topography
fig, ax = plt.subplots(1)
mne.viz.plot_topomap(snrs_E2_chaverage, epochs.info, vlim=(1, None), axes=ax)

#F1 at 4.2hz
snrs_F1 = snrs[i_trial_F1, :, i_bin_42hz]
snrs_F1_chaverage = snrs_F1.mean(axis=0)
# plot SNR topography
fig, ax = plt.subplots(1)
mne.viz.plot_topomap(snrs_F1_chaverage, epochs.info, vlim=(1, None), axes=ax)
...
#F1 at 6hz (5.7)
snrs_F1 = snrs[i_trial_F1, :, i_bin_6hz]
snrs_F1_chaverage = snrs_F1.mean(axis=0)
# plot SNR topography
fig, ax = plt.subplots(1)
mne.viz.plot_topomap(snrs_F1_chaverage, epochs.info, vlim=(1, None), axes=ax)
